...
<body>
  ...
  <div class="header bg-light">
    <div class="container p-3">
      <h1><span class="fa fa-user"></span> Cereals</h1>
    </div>
  </div>
  ...
  <div class="container my-5">
      ...
      <div class="row bg-light mb-5">
        ...
        <div class="col-md-6">
            <img src="new/rice.jpg" alt="" class="img-responsive" style="height:350px;">
        </div>
      ...
      <div class="row bg-light">
        ...
        <div class="col-md-6">
            <img src="new/maize.jpg" alt="" class="img-responsive" style="height:350px;">
        </div>
