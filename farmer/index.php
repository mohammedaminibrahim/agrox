...
<body>
  ...
  <div class="header bg-light">
    <div class="container p-3">
      <h1><span class="fa fa-user"></span> Farmer</h1>
    </div>
  </div>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="card bg-primary mb-3">
            ...
            <div class="card-img-overlay text-center text-white">
              <h3>Products</h3>
              <h1 class="display-4"><span class="fa fa-users"></span> 6</h1><br>
              <a href="orders.php" class="btn btn-sm btn-outline-light">Add product</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="card bg-primary mb-3">
            ...
            <div class="card-img-overlay text-center text-white">
              <h3>Requests</h3>
              <h1 class="display-4"><span class="fa fa-shopping-cart"></span> 2</h1><br>
